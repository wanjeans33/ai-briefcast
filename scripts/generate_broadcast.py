...
CARDS_SYNCED_INSTRUCTION = (
    ...
    "- 第 1 段（开场白）→ cover：{\"kind\":\"cover\",\"badge\":\"建议收藏 · 每日AI速览\",\"title\":\"≤10字主标题\",\"subtitle\":\"如 6月X日 · 今日AI要闻\"}\n"
    "- 最后一段（收尾）→ cta：{\"kind\":\"cta\",\"title\":\"如 明天见\",\"subtitle\":\"一句话\",\"tags\":[\"关注\",\"收藏\",\"分享\"]}\n"
    "- 中间每段 → point：{\"kind\":\"point\",\"tag\":\"如 头条 01 · 行业 / 论文 · 全模态\",\"title\":\"≤10字\",\"body\":\"≤60字，口语化，用 **加粗** 标出关键数字/词\"}\n"
    "要求：每张卡只浓缩它对应那一段的内容，不要跨段；只用稿中事实不杜撰；"
    "公司/产品/模型等英文专有名词保留英文；数字可用阿拉伯数字；语言精炼有网感。"
)
